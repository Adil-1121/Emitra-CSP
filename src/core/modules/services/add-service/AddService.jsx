...
const AddService = () => {
    ...
    const [serviceImage, setServiceImage] = useState(null); // preview
    ...
    const handleChange = (e, name) => {
        const value = e.target ? e.target.value : e; // For Calendar & Dropdown
                        ...
                        <div className="p-field p-col-12 p-md-6">
                            ...
                            <InputText
                                ...
                                className={classNames({
                                    "p-invalid": submitted && !formData.title,
                                })}
                            />
